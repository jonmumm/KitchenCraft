...
export default function Preferences() {
  ...
  const initialPreferencesState: OnboardingInput["preferences"] = {
    ...
    enjoysInternationalCuisine: undefined,
  ...
  const preferencesDisplayNames: {
    ...
    organic: "Do you prefer organic ingredients?",
    ...
    enjoysInternationalCuisine: "Do you enjoy international cuisine?",
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <h1 className="text-xl font-bold mb-4">Select Your Preferences</h1>
