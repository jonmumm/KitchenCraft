...
export const AutoSuggestIngredientsOutputSchema = z.object({
  ingredients: z.array(z.string()),
});

export type AutoSuggestIngredientEvent = StreamObservableEvent<
  "INGREDIENT",
  z.infer<typeof AutoSuggestIngredientsOutputSchema>
>;

export class AutoSuggestIngredientStream extends TokenStream<{
  prompt: string;
}> {
