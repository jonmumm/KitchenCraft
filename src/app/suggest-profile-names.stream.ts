    ...
    const previousSuggestionsText =
      input.previousSuggestions.length > 0
        ? " and considering the previous suggestions provided: " +
          ...
          ". Avoid giving suggests similar to these, instead provide ones that are considerabily different. It's okay to provide more 'random' suggestions if the number of suggestions is already quite large (i.e > 12)"
        : "";
