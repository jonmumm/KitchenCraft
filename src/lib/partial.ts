// copied from https://github.com/colinhacks/zod/blob/master/src/helpers/partialUtil.ts
// for some reason its not exported but we need it

import { ZodTypeAny, ZodObject, ZodRawShape, ZodOptional, ZodArray, ZodNullable, ZodTuple, ZodTupleItems } from "zod";
